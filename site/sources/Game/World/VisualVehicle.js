...
export class VisualVehicle
{
    ...
    setPaints()
    {
        ...
        this.paints.choices.orange = this.game.materials.createGradient('orangeGradient', '#cba0ff', '#8652bb', this.game.materials.debugPanel?.addFolder({ title: 'orangeGradient' }))
        ...
        this.paints.choices.black = this.game.materials.createGradient('blackGradient', '#9574b6', '#3c2d55', this.game.materials.debugPanel?.addFolder({ title: 'blackGradient' }))
        
        // Flames
        {
            const material = this.paints.choices.red.clone()
            const baseOutput = material.outputNode
            const colorA = uniform(color('#ffb5ea'))
            const colorB = uniform(color('#ae58de'))
