...
// Soft pink atmosphere, but near-neutral sunlight so wood/foliage retain their hues.
const presets = {
    day:   { revealColor: new THREE.Color('#f4a7e4'), revealIntensity: 12, electricField: 0, temperature: 5, lightColor: new THREE.Color('#fff6ed'), lightIntensity: 1.15, shadowColor: new THREE.Color('#929aac'), fogColorA: new THREE.Color('#ecd5fa'), fogColorB: new THREE.Color('#efbfdf'), fogNearRatio: 0.45, fogFarRatio: 1.6 },
    dusk:  { revealColor: new THREE.Color('#ff86d9'), revealIntensity: 5.55, electricField: 0.25, temperature: 0, lightColor: new THREE.Color('#f5d9cb'), lightIntensity: 1.05, shadowColor: new THREE.Color('#7c7d9c'), fogColorA: new THREE.Color('#9975ca'), fogColorB: new THREE.Color('#e4a6d0'), fogNearRatio: 0.2, fogFarRatio: 1.5 },
    night: { revealColor: new THREE.Color('#b678ff'), revealIntensity: 10, electricField: 1, temperature: -7.5, lightColor: new THREE.Color('#a6b9dc'), lightIntensity: 1.25, shadowColor: new THREE.Color('#626b8b'), fogColorA: new THREE.Color('#372351'), fogColorB: new THREE.Color('#633657'), fogNearRatio: 0.1, fogFarRatio: 1.4 },
    dawn:  { revealColor: new THREE.Color('#ff9d9d'), revealIntensity: 4.85, electricField: 0.25, temperature: 0, lightColor: new THREE.Color('#f9e7d9'), lightIntensity: 1.1, shadowColor: new THREE.Color('#9790a6'), fogColorA: new THREE.Color('#d6b4ef'), fogColorB: new THREE.Color('#f5b8cf'), fogNearRatio: 0.35, fogFarRatio: 1.5 },
}
