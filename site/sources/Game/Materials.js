...
export class Materials
{
    constructor()
    {
        ...
        this.createEmissiveGradient('emissiveOrangeRadialGradient', worldPalette.lamp.core, worldPalette.lamp.edge, worldPalette.lamp.intensity, true, this.debugPanel?.addFolder({ title: 'emissiveOrangeRadialGradient' }))
        ...
        this.createEmissiveGradient('emissiveGreenRadialGradient', '#eeffd0', '#82be63', 1.7, true, this.debugPanel?.addFolder({ title: 'emissiveGreenRadialGradient' }))
        ...
        this.createGradient('redGradient', '#ffa0d1', '#994aae', this.debugPanel?.addFolder({ title: 'redGradient' }))
    }
