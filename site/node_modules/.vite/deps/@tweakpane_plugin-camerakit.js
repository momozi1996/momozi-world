...
// node_modules/@tweakpane/plugin-camerakit/dist/tweakpane-plugin-camerakit.js
...
var RingView = class {
  constructor(doc, config) {
    ...
    this.element = doc.createElement("div");
    this.element.classList.add(className$1(), className$1(void 0, `m${config.seriesId}`));
    config.viewProps.bindClassModifiers(this.element);
    this.value_ = config.value;
    this.value_.emitter.on("change", this.onValueChange_);
  ...
  onShowsTooltipChange_(ev) {
    if (ev.rawValue) {
      this.element.classList.add(className$1(void 0, "tt"));
    } else {
      this.element.classList.remove(className$1(void 0, "tt"));
    }
  }
};
var RingController = class {
  constructor(doc, config) {
    this.ox_ = 0;
    this.ov_ = 0;
    this.onPointerDown_ = this.onPointerDown_.bind(this);
...
var className = ClassName("ckrtxt");
var RingTextView = class {
  constructor(doc, config) {
    this.element = doc.createElement("div");
...
var RingInputPlugin = createPlugin({
  id: "input-ring",
  type: "input",
...
var WheelInputPlugin = createPlugin({
  id: "input-wheel",
  type: "input",
  accept(exValue, params) {
    if (typeof exValue !== "number") {
