...
export class Materials
{
    constructor()
    {
        ...
        this.createEmissiveGradient('emissiveOrangeRadialGradient', '#ffb6df', '#d155af', 1.7, true, this.debugPanel?.addFolder({ title: 'emissiveOrangeRadialGradient' }))
        ...
        this.createEmissiveGradient('emissiveGreenRadialGradient', '#f9d2ff', '#c084ed', 1.5, true, this.debugPanel?.addFolder({ title: 'emissiveGreenRadialGradient' }))
